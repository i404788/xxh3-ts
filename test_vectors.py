...
for len in [0, 1, 2, 3, 6, 12, 18, 32+18, 64, 96]:
    ...
    xxh3_128_res = '✅' if local_xxh3_128_hash == ref_xxh3_128_hash else f"xxh3_128 not eq to ref, {local_xxh3_128_hash=:x} != {ref_xxh3_128_hash=:x}"
